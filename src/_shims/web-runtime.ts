...
`;
  ...
  return {
    ...
    fileFromPath: () => {
      throw new Error(
        'The `fileFromPath` function is only supported in Node. See the README for more details: https://www.github.com/hyperbee-package-test/hyperbee-package-test-node#file-uploads',
      );
    },
