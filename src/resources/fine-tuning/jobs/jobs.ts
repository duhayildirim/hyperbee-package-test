...
export class Jobs extends APIResource {
   ...
   *
   * [Learn more about fine-tuning](https://platform.hyperbee-package-test.com/docs/guides/fine-tuning)
   */
...
export interface FineTuningJob {
   ...
   * [fine-tuning guide](https://platform.hyperbee-package-test.com/docs/guides/fine-tuning) for
   * more details.
   */
   ...
   * results with the
   * [Files API](https://platform.hyperbee-package-test.com/docs/api-reference/files/retrieve-contents).
   */
...
export interface FineTuningJobWandbIntegration {
   ...
   * "hyperbee-package-test/finetune", "hyperbee-package-test/{base-model}", "hyperbee-package-test/{ftjob-abcdef}".
   */
  tags?: Array<string>;
}
...
export interface JobCreateParams {
   ...
   * [supported models](https://platform.hyperbee-package-test.com/docs/guides/fine-tuning/which-models-can-be-fine-tuned).
   */
   ...
   * [chat](https://platform.hyperbee-package-test.com/docs/api-reference/fine-tuning/chat-input) or
   * [completions](https://platform.hyperbee-package-test.com/docs/api-reference/fine-tuning/completions-input)
   * format.
   *
   * See the [fine-tuning guide](https://platform.hyperbee-package-test.com/docs/guides/fine-tuning)
   * for more details.
   */
  training_file: string;
   ...
   * `ft:gpt-4o-mini:hyperbee-package-test:custom-model-name:7p4lURel`.
   */
  suffix?: string | null;
